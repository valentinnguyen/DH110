...
|3. **User Control & Freedom:** Options that user has when navigating the app. | When a user wants to make a profile on the website, there are three options on the bottom righthand corner: cancel, previous, and next. Useres have the option to select either of these buttons if they want to stop the process, go to the previous page, or move to the next page. | ------- | ------- |
|4. **Consistency & Standards:** Design and format of the pages are consistent throughout the whole site/app.| The navigation bar holds the necessary information that the user will most likely need, such as the "about" page and "contact" page. | The navigation bar might have too many options for the user to take in at first glance and could just provide the essential pages for users new to the site.| Keep the navigation bar limited to only the essentials and bring the extra menu options down in a dropdown menu under those essential tabs. |
|5. **Recognition Rather Than Recall:** | ------- | ------- | ------- |
|6. **Error Prevention:** | When the user fills out the form to make a profile, there is an asterisk next to the fields that they must fill out before moving on to the next page. | The asterisks are difficult to see at first glance because of how small they are; they don't pop up otherwise. | Change the color of the asterisk so that they are more noticeable. |
|7. **Flexbility and Efficiency of Use:** | Throughout the pages on the website are buttons that users can click on if they want to learn more about a piece of information that was said (i.e. "See all news," "Explore more articles," "Find out more," etc.). | Pages can be long to scroll through, and no option appears to go to the navigation bar when the user is halfway through the whole page. | While the user scrolls down a page, add an option on the side or bottom of the page that allows the user to go "back to the top," or allow the navigation bar to stay on the screen while the user scrolls down the page. |
|8. **Aesthetic & Minimalistic Design:** | The main homepage and the rest of the pages on the website are consistent in color and layout. Typeface choice is clear to read and are the approriate sizes (headers are larger fonts, paragraphs are smaller, etc.). Paragraphs are organized in blocks and sections in every page, making information easy to read and scroll through. | The page where users make a profile does not match the main website in format, colors, and overall layout. | Keep every page consistent and apply the same rules of design of aesthetic with the main homepage of the site. |
|9. **Help Users Recognize, Diagnose, and Recover from Errors:** | When a user does not fill out a part of the form that is required, the page will immediately mention which area of the form the user needs to fill out in red font. | On the search bar, there is no indication for advanced search filters. A user would not know if their formatting in hteir search is correct or not. | Add a dropdown menu while the user types in the search bar so that they know what they're typing is formatted correctly. |
|10. **Help & Documentation:** | In  the nevigation bar, there is a "contact" tab clearly there for users to click on. There is also an option to look at FAQs under the "about" tab. | None. | It might be better to make the FAQ more obviously visual, but it isn't the biggest issue on the website overall. |
